        ...
        <ul class="list-inline float-right mb-0">
            ...
            {{-- <li class="list-inline-item dropdown notification-list">
                <a
                    ...
                    aria-expanded="false"
                    ><i
                        class="dripicons-mail noti-icon"
                    ></i>
                    <span
            ...
            <li class="list-inline-item dropdown notification-list">
                <a
                    ...
                    aria-expanded="false"
                    ><i
                        class="dripicons-bell noti-icon"
                    ></i>
                    <span
            ...
            <li class="list-inline-item dropdown notification-list">
            <a href="{{url('/profile')}}" class="nav-link dropdown-toggle arrow-none waves-effect nav-user" role="button" aria-haspopup="false" aria-expanded="false">
